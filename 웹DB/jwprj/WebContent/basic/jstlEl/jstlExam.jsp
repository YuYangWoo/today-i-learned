...
<p> 
product name(jstl): <c:out value="${product}" default="Not registered" escapeXml="true"/>
</p>
...
<c:if test="${checkout }">
<p>Order: ${product }</p></c:if>
<c:if test="${!checkout }">
<p>No checkout!!</p></c:if>

<c:if test="${!empty product }">
<p><b>${product } Already added!!.</b></p>
</c:if>
